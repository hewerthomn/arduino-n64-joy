...
public class N64_Processing extends PApplet {
...
public void serialEvent(Serial N64Connection)
{
  ...
  for (int i = 0; i <= 15; i++)
  {
    if (pressed[0].charAt(i) == ('4'))
    {
      ...
      case 12:
        if(!cu) 
        {
          VKey.keyPress(KeyEvent.VK_L);// CUp
          cu = !cu;
        }
        break;
      case 13:
        if(!cd) 
        {
          VKey.keyPress(KeyEvent.VK_I);// CDown
          cd = !cd;
        }
        break;
      case 14:
        if(!cl) 
        {
          VKey.keyPress(KeyEvent.VK_V);// CLeft
          cl = !cl;
        }
        break;
      case 15:
        if(!cr) 
        {
          VKey.keyPress(KeyEvent.VK_E);// CRight
          cr = !cr;
        }
        break;      
    }}
    if (pressed[0].charAt(i) == ('0'))
    {
      ...
      case 12:
        if(cu) 
        {
          VKey.keyRelease(KeyEvent.VK_L);// CUp
          cu = !cu;
        }
        break;
      case 13:
        if(cd) 
        {
          VKey.keyRelease(KeyEvent.VK_I);// CDown
          cd = !cd;
        }
        break;
      case 14:
        if(cl) 
        {
          VKey.keyRelease(KeyEvent.VK_V);// CLeft
          cl = !cl;
        }
        break;
      case 15:
        if(cr) 
        {
          VKey.keyRelease(KeyEvent.VK_E);// CRight
          cr = !cr;
        }
        break;  
      }}}}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "N64_Processing" };
    if (passedArgs != null) {
